...
namespace FileDigester {
	...
	private:
		...
		//Normal Hash Algs
		array<System::Byte>^ MD5_Hash_File(System::IO::FileStream^% FiletoHash);
		array<System::Byte>^ RIPEMD160_Hash_File(System::IO::FileStream^% FiletoHash);
		array<System::Byte>^ SHA1_Hash_File(System::IO::FileStream^% FiletoHash);
		array<System::Byte>^ SHA256_Hash_File(System::IO::FileStream^% FiletoHash);
		array<System::Byte>^ SHA384_Hash_File(System::IO::FileStream^% FiletoHash);
		array<System::Byte>^ SHA512_Hash_File(System::IO::FileStream^% FiletoHash);
